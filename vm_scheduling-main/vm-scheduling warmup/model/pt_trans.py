...
class Net(nn.Module):
    def __init__(self, params):
        ...
        self.pm_encode = nn.Linear(params.pm_cov, params.d_hidden)  # 8 --> hidden   2x (cpu, memory, fr = (mem_left % 16) / mem_left)  # (mem_left % 16) / 16
        self.vm_encode = nn.Linear(params.vm_cov, params.d_hidden)  # 14 --> hidden    # mem_left % 16 --> pm == 15, --> vm == 1   --> 16
