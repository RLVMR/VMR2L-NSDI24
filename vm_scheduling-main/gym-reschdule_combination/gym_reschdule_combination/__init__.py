...
register(
    id="penalty-v1",
    entry_point="gym_reschdule_combination.envs:VM_penalty_v1",
)
register(
    id="graph-v1",
...
register(
    id="graph-v3",
    entry_point="gym_reschdule_combination.envs:VM_graph_v3",
)
register(
    id="graph-v4",
    entry_point="gym_reschdule_combination.envs:VM_graph_v4",
)