...
def parse_args():
    ...
    parser.add_argument("--gym-id", type=str, default="graph-v3",
...
if __name__ == "__main__":
    ...
    run_name = f"tm20_g4_{args.vm_data_size}{args.max_steps}_{args.gym_id}_{__file__[:__file__.find('.py')]}_{args.seed}" \
               f"_{utils.name_with_datetime()}_dh32_dff128"
    ...
    obs_edges = torch.zeros(num_steps, num_trials, num_envs, params.num_vm + params.num_pm, 1,
