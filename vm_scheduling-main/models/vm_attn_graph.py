...
class VM_candidate_model(nn.Module):
    def __init__(self, params):
        ...
        self.pm_encode = nn.Linear(params.pm_cov + self.d_hidden, params.d_hidden)
        self.vm_encode = nn.Linear(params.vm_cov + self.d_hidden, params.d_hidden)
...
class VM_Attn_Graph_Wrapper(nn.Module):
    def __init__(self, params, pretrain=False):
        super(VM_Attn_Graph_Wrapper, self).__init__()
